    ...
    xhr.onreadystatechange = function(){
        ...
        if(xhr.readyState === 4 && xhr.status === 200){
            ...
            /*
                ...
                Here we have used an enhanced for loop syntax. Please note that you can also us the "in" keyword in a JS loop, but bthat "in" is used to iterate over the properties of an oject.
            */
            ...
            let reimbursement_container = document.getElementById('reimbursementContainer');
            ...
            new_h3.innerText = reimbursement.reimbursement_id;

            let new_para = document.createElement('p');
            new_para.innerText = reimbursement.description;
